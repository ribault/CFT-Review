...
%\documentclass[14pt, a4paper, notitlepage, twoside]{extreport}
...
\usepackage[colorlinks=true,linktoc=none,linkcolor=blue,citecolor=red,urlcolor=black]{hyperref}
%\usepackage[colorlinks=true,linktoc=all,linkcolor=black,citecolor=black,urlcolor=black]{hyperref}
...
{\normalsize CEA Saclay, Institut de Physique Th\'eorique}
 \\
 {\footnotesize \ttfamily sylvain.ribault@ipht.fr  ,  http://researchpracticesandtools.blogspot.fr/ }
}
...
\textbf{Version}
\end{center}
\noindent This text corresponds to arXiv's fourth version, \texttt{https://arxiv.org/abs/1406.4290v4} 

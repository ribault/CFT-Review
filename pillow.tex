...
\end{multline}
This is not of the type \eqref{ghh} with $\Delta$-independent $h_L$. If it was, we would have to explain how the $c$-dependence arises from the Ward identities. To bring it closer we can rewrite it as 
\begin{multline}

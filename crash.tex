...
\title{\bfseries Crash course on two-dimensional \\ conformal field theory}
...
In conformal field theory, the axiomatic approach is also called the conformal bootstrap approach. 

In the first three sections, we will introduce the axioms of two-dimensional conformal field theories.
...
They allow us to deduce important properties of the spectrums and correlation functions.
Next, we introduce additional axioms that single out Liouville theory. We then compute and study its three- and four-point functions.
...
\bibitem{rib16}
\href{http://arxiv.org/abs/1609.09523}{S.~Ribault} (2016) [1609.09523]\\
  {\em {Minimal lectures on two-dimensional conformal field theory}\/}

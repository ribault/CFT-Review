...
We will now introduce the conformal field theory of free bosons. We will not need free bosons in the following, as we will use the conformal bootstrap rather than perturbative methods. However, free bosons provide the simplest examples of CFTs with extended symmetry algebras, i.e. algebras that are strictly larger than the Virasoro algebra: in this case, the abelian affine Lie algebra. This is a good preparation for Wess--Zumino--Witten models, with their non-abelian affine Lie algebras.
...
\end{align}
Deduce that the spectrum is of the type 
 \begin{align}
...
\begin{enumerate}
 \item How are tutorials organized? Should lecture notes be adapted to tutorials? For instance, by listing all exercises, or choosing which exercises to do?

...
\begin{align}
 ...
 \end{align}
 Furthermore, using the pentagon relation where $\mathcal{V}_{\Delta_5}$ is replaced with the identity representation $\mathcal{R}_{\langle 1,1\rangle}$, we find that the inverse fusing matrix can be rewritten in terms of the fusing matrix,
 \begin{align}

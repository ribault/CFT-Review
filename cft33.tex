...
Let us draw some relevant regions of the $c$-complex plane. We use light blue for $\{c\leq 1\}$, blue for the rest of the plane, and red for the discrete central charges of minimal models (with larger bars for smaller spectrums). We use darker colors for 

...
\end{itemize}
Let us now introduce an axiom about fusion of Virasoro representations. While the symmetry algebra is $\mathfrak{V}\times \overline{\mathfrak{V}}$, we define the fusion of representations of $\mathfrak{V}$ alone, thanks to the factorization of symmetry constraints on OPEs. 

...
\label{tsl}
\end{align}
This is called the \textbf{\boldmath Virasoro field}\index{Virasoro field}: a field which encodes the action of the Virasoro algebra at all points. 
...
Notice also that the term $\frac{c}{2}$ should be understood as $\frac{c}{2}I$ where $I$ is the \textbf{\boldmath identity field}\index{identity field}, a field whose presence does not affect correlation functions, and which is in particular $z$-independent,
\begin{align}

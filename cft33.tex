...
Using the universal factors $g^L_{\Delta_s,\Delta_3,\Delta_4}$ \eqref{glvv}, the expression \eqref{4ope} of our four-point function can be written as a conformal block decomposition \eqref{fsd}, where the blocks are 
\begin{align}

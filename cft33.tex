...
% 142 pages. Public domain. Suggest modifications at this https URL . Version 6:
...
\label{jayi}
\end{align}
Given $N$ fields $\Phi^{\sigma_i}(z_i)$, and any meromorphic function $\epsilon(z)$, with no poles outside $\{z_1,\cdots z_N\}$, we therefore have 
\begin{align}

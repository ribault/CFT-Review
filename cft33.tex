...
Now this relation is equivalent to $\frac{\partial}{\partial z} T(y) = \frac{\partial}{\partial \bar z} T(y) = 0$, where we define the \textbf{\boldmath energy-momentum tensor}\index{energy-momentum tensor} $T(y)$ as 
\begin{align}
...
\end{align}
Let us call the $n=-1,0$ identities global Ward identities, and show that they determine the dependence of the OPE coefficients $C_{\sigma_1,\sigma_2}^\sigma(z_1,z_2)$ on $z_1,z_2$:
\begin{itemize}
 \item Using Axiom \ref{ax:dvz}, the $n=-1$ identity becomes 
 \begin{align}
...
Using the OPE again on the left-hand side, this implies $\left(\frac{\partial}{\partial z_1} +\frac{\partial}{\partial z_2}\right) C_{\sigma_1,\sigma_2}^\sigma(z_1,z_2)=0$ -- translation invariance of the OPE coefficients. 
 \item Similarly, the $n=0$ identity determines the behaviour of the OPE coefficients under dilatations. 
\end{itemize}
Assuming the fields $V_{\sigma_1}, V_{\sigma_2}$ and $V_\sigma$ are  $L_0$-eigenvalues with the respective dimensions $\Delta_{\sigma_1}, \Delta_{\sigma_2}$ and $\Delta_\sigma$, the solution of the global Ward identities is 
\begin{align}
 C_{\sigma_1,\sigma_2}^\sigma(z_1,z_2) \propto (z_1-z_2)^{\Delta_{\sigma}-\Delta_{\sigma_1}-\Delta_{\sigma_2}} \ .
\end{align}

The $n\geq 1$ Ward identities are local Ward identities, and they determine the coefficients of descendent fields $V_\sigma$ in terms of the coefficients of the corresponding primary fields.
Before illustrating this property of local Ward identities in the case of low level descendent fields, let us see how it affects the structure of the OPEs. Taking for simplicity $V_{\sigma_1}$ and $V_{\sigma_2}$ to be primary fields, the OPE reads

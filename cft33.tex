...
Relaxing the assumption that we have diagonal states, generic maximal spectrums are built from any two vectors $\vec\alpha_1,\vec\alpha_2$ that have integer spins $s_1,s_2$, and are such that $\alpha_1+\alpha_2$ also has an integer spin $s$. The resulting theory describes a compactified free boson if and only if there are integers $n_1,n_2,w_1,w_2$ such that
\begin{align}

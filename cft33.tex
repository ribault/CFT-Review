...
But since $|q|\leq 1$ for any $x\in\mathbb{C}$, with $|q|=1 \iff x\in (1,\infty)$, Zamolodchikov's recursion representation converges for $x\in \mathbb{C}-(1,\infty)$, whereas the formula \eqref{gsd} only converges for $|x|<1$.

...
\fbox{
\begin{minipage}{0.9\textwidth}
Two-dimensional \textbf{\boldmath conformal field theory}\index{conformal field theory}: the study of two-dimensional quantum field theories which possess a $\mathfrak{V}\times \overline{\mathfrak{V}}$ symmetry algebra such that $L_n$ and $\bar{L}_n$ generate conformal transformations. 
\end{minipage}
}
\end{center}
...
should be understood as \textbf{\boldmath locally holomorphic}\index{locally holomorphic}: the $z$-dependent factors are supposed to be $\bar{z}$-independent, but they can have singularities such as poles and branch cuts.
...
\item we anticipate that fusion multiplicities are trivial, as we will check below,
 \item the OPE's universal parts, like the Ward identities, should respect holomorphic factorization, invariance under translations, and dimensional analysis \eqref{zaz},

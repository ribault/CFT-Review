...
\begin{multline}
  \left\{ (x-z_1)(x-z_2)(x-z_3)\left(-\frac{1}{b^2}\frac{\partial^2}{\partial x^2} +\left[\frac{1}{x-z_1}+\frac{1}{x-z_2}+\frac{1}{x-z_3}\right] {\frac{\partial}{\partial x}} \right) \right.
\\ 

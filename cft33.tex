...
Since $\hat{\mathfrak{u}}_1$-primary fields are also Virasoro-primary, their OPEs must be of the type 
\begin{align}
...
\label{sz}
\end{align}
This theory is unitary for $Q\in {\mathbb{R}}$, see eq. \eqref{aif}.
...
Given the unitarity condition \eqref{aif}, we need $Q=0$ so that the central charge is 
\begin{align}
 c=1\ .
\end{align}

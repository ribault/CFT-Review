...
\begin{align}
 \mathcal{F}(\widetilde{SL}_2(\mathbb{R})) &= \int^\oplus_{-\frac12+i{\mathbb{R}}_+} dj \int^\oplus_{]0,1[} d\alpha\ \mathcal{C}^j_\alpha \otimes \bar{\mathcal{C}}^j_{\alpha} \oplus \bigoplus_\pm \int^\oplus_{]-\frac12, \infty[} dj\ \mathcal{D}^{j,\pm}\otimes \bar{\mathcal{D}}^{j,\pm} \ ,
\label{fst}
\\
 \mathcal{F}(SL_2(\mathbb{R})) &= \int^\oplus_{-\frac12+i{\mathbb{R}}_+} dj \bigoplus_{\alpha\in\{0,\frac12\}} \mathcal{C}^j_\alpha \otimes \bar{\mathcal{C}}^j_{\alpha} \oplus \bigoplus_\pm \bigoplus_{j=-\frac12, 0,\frac12 \cdots} \mathcal{D}^{j,\pm}\otimes \bar{\mathcal{D}}^{j,\pm} \ ,
\end{align}
...
\begin{align}
 \rho_{-1}(\hat{\mathcal{D}}^{j,+}) = \hat{\mathcal{D}}^{-j-2-\frac{k}{2},-} \ .
\label{rdd}
\end{align}
So the spectral flow orbit of $\hat{\mathcal{D}}^{j,+}$ contains two affine highest-weight representations, namely $\hat{\mathcal{D}}^{j,\frac12} = \hat{\mathcal{D}}^{j,+}$ itself and $\hat{\mathcal{D}}^{j,-\frac12} = \hat{\mathcal{D}}^{-j-2-\frac{k}{2},-}$.
...
However, by computing the norms of level one states, it is easy to see that the affine highest-weight representations $\hat{\mathcal{C}}^j_\alpha, \hat{\mathcal{D}}^{j,\pm}$  are not unitary.

...
Moreover, we have obtained a formula for the degenerate OPE coefficient in terms of the two- and three-point structure constants. Using the explicit expressions of these structure constants, this formula becomes
...
refer to/from appropriate exercise.



This does not happen if $c\in]-\infty, 1]$, as the three-point structure constant does not have the right type of poles.
To summarize, 
\begin{align}
 \boxed{

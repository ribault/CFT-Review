...
\subsection{\texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl2} fusion rules and minimal models}

In the same way as we recovered the fusion rules of degenerate Virasoro fields from the OPE of Liouville theory in Section \ref{seceul}, we will deduce the fusion rules of degenerate $\widehat{\mathfrak{sl}}_2$ fields from the OPE of the $H_3^+$ model. 
This will allow us to build \textbf{\boldmath $\widehat{\mathfrak{sl}}_2$ minimal models}\index{minimal model!$\widehat{\mathfrak{sl}}_2$---}, i.e. models  whose spectrums are made of finitely many irreducible representations of the $\widehat{\mathfrak{sl}}_2$ algebra.

\subsubsection{Degenerate fields and fusion rules}

Let us analytically continue the OPE of the $H_3^+$ model \eqref{xope} to values of the spin $j_1$, such that the integral on $j$ reduces to a finite sum. 

...
\begin{multline}
 ...
 \\ \times 
 \frac{\Upsilon_b(2P+Q)\Upsilon_b(2P+2ib+2jb^{-1})}{\prod_\pm \Upsilon_b(\frac{Q}{2}+2P\pm P_{\langle r,s\rangle} +ib+jb^{-1})}
 \ ,
\end{multline}
...
In the special case $i=-\frac{r-1}{2}, j=-\frac{s-1}{2}$, we have $ib+jb^{-1} = \frac{Q}{2}-P_{\langle r,s\rangle} $, so that 
\begin{align}
...
Rather do it like table \eqref{ccr} ... or combine?

...
This uniqueness statement would however be more powerful, if we could drop the assumption that degenerate fields exist.
Do not say under which assumptions on $P_i$ and $c$, we use crossing-symmetry equation \eqref{ffm} with no degenerate field.

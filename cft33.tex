...
It turns out that the spectrum of the WZW model is still diagonal for all positive integer values of $k$, \cite{fms97}
\begin{align}
...
\begin{align}
 \boxed{k\in]-\infty,-2[}\ .
\end{align}
The natural conjectures for the spectrums of the $\widetilde{SL}_2(\mathbb{R})$ and $SL_2(\mathbb{R})$ WZW models is then
\begin{align}

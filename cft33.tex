...
\item that conformal dimensions are real if the central charge is real;
...
\end{enumerate}
Let us show that these assumptions determine the spectrum of Liouville theory.
...
Exploit reality assumption. Look for lower bound on dimensions: like meromorphicity, use natural variable (for fusion rules) i.e. momentum not dimension, then use critical point $\Delta'(\alpha)=0$ function. Do we still need diagram of allowed $\alpha$? yes probably.

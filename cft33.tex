...
\begin{itemize}
 ...
 % NB: Shows that \eqref{ffm} does not hold in such cases. But for c=1 the fusing relation is not particularly pathological, see Iorgov-Lisovyy-Tykhyy.
 \begin{align}
...
Let us schematically summarize the limits we have been discussing, see also the diagram \eqref{lims}. We denote (generalized) minimal models as (G)MM, and Runkel--Watts-type theorys as RWT. We begin with limits of minimal models:
\begin{align}
...
Let us adopt a basis of the Lie algebra that includes a timelike matrix such as $\left(\begin{smallmatrix} 0 & 1 \\ -1 & 0 \end{smallmatrix}\right)$ as its Cartan generator.

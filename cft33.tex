...
\end{align}
In the case $n=-1$, using Axiom \ref{ax:dvz}, this identity becomes $\left(\frac{\partial}{\partial z_1} +\frac{\partial}{\partial z_2}\right) V_{\sigma_1}(z_1)V_{\sigma_2}(z_2) = \sum_\sigma C_{\sigma_1,\sigma_2}^\sigma(z_1,z_2) \frac{\partial}{\partial z_2} V_\sigma(z_2)$. Using the OPE again, this implies $\left(\frac{\partial}{\partial z_1} +\frac{\partial}{\partial z_2}\right) C_{\sigma_1,\sigma_2}^\sigma(z_1,z_2)=0$ -- translation invariance of the OPE coefficients. 
Similarly, in the case $n=0$, our identity determines the behaviour of the OPE coefficients under dilatations. Taken together the $n=0$ and $n=-1$ cases determine the dependence of the OPE coefficients on $z_1,z_2$.
Assuming the fields $V_{\sigma_1}, V_{\sigma_2}$ and $V_\sigma$ are  $L_0$-eigenvalues with the respective dimensions $\Delta_{\sigma_1}, \Delta_{\sigma_2}$ and $\Delta_\sigma$, this dependence is 
\begin{align}

...
\label{vtv}
\end{align}
where we define the image $T_gV_{\Delta,\bar\Delta}(z)$ of a quasi-primary field as
\begin{align}
...
But $V_{\Delta,\bar\Delta}(-\frac{1}{z})$ is smooth at $z=\infty$, and we obtain
\begin{align}

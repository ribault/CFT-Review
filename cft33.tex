...
% NB: sketch
See pedestrian computation for a few terms of series in x.
Def. from OPEs defines block where OPE converges. Presence of extra field leads to singularity so radius of cvgce of s-channel looks like 1, see also hypergeom blocks, no known proof. Blocks defined elsewhere by ana. continuation, but multivalued. (monodromy manifest around 0, also nontrivial around 1, infinity, cf hypergeom.) Zamo recursion is a representation that makes it manifest. 
...
% NB: sketch
Show radius of convergence is one, therefore defining blocks everywhere.
...
% NB: sketch
Converges more slowly, and/or on smaller region?
...
\\
 ...
 & \supset \left\{\text{Liouville}_{c_{p_0,q_0}}, \text{RWL}_{p_0,q_0}\right\}\ ,
 \\
 \lim_{\substack{p,q\to \infty \\ c_{p,q}\to c }} \text{RWL}_{p,q} & = \text{Liouville}_{c}\ .
\end{align}

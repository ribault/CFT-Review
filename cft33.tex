...
\subsubsection{Normalization-invariant quantities} 
...
removing a factor $\prod_{i=1}^4 N_i$ on both sides, this becomes
\begin{align}
...
The shift equations prescribe how the three-point structure constant $C_{P_1,P_2,P_3}$ behaves under shifts of $P_1$ by $b$ and $\frac{1}{b}$.

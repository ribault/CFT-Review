...
This implies that $\left\langle V_{\Delta_1,\bar\Delta_1}(z_1)\right\rangle$ is constant, and vanishes unless $\Delta_1=\bar\Delta_1=0$ and our primary field has vanishing level one descendents $L_{-1}V_{0,0}=\bar{L}_{-1}V_{0,0}=0$.

...
\begin{center}
\textit{\noindent Habilitation thesis defended on 21 December 2018, in front of a jury composed of
} \vspace{3mm}

\begin{tabular}{ll} Denis Bernard & \\ Matthias Gaberdiel & (Rapporteur) \\ Jesper Jacobsen & (Rapporteur) \\ Vyacheslav Rychkov & \\ Véronique Terras & \\ Gérard Watts& (Rapporteur) \\ Jean-Bernard Zuber & \end{tabular}
\end{center}
...
I wish to thank Matthias Gaberdiel, Jesper Jacobsen and G\'erard Watts for acting as referees of this habilitation thesis, and for providing feedback on this text.
...
Moreover, $P$ is the momentum, and $P_{\langle r,s \rangle}$ \eqref{ars} are its values for degenerate representations.)
...
On the other hand, a conformal block in general has a pole when the $s$-channel dimension takes a degenerate value $\Delta_s=\Delta_{\langle r,s\rangle}$, as is manifest in Zamolodchikov's recursion representation \eqref{hrec}.
...
In particular, the conformal blocks that appear in (generalized) minimal models can be computed using Zamolodchikov's recursion representation, although they involve degenerate $s$-channel dimensions. 

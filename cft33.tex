...
\begin{itemize}
 ...
 \begin{align}
  ...
  \label{sigma}
 \end{align}
We will call the corresponding theories \textbf{Runkel--Watts-type theorys}\index{Runkel--Watts-type theory}, for reasons that will become apparent in Section \ref{secltf}.
\end{itemize}
...
Let us schematically summarize the limits we have been discussing. We denote (generalized) minimal models as (G)MM, and Runkel--Watts-type theorys as RWT. We begin with limits of minimal models:
\begin{align}

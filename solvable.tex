...
If $r$ is integer, the condition for the second index of $V_{(r,s)}$ reduces to the integer spin condition $s\in\frac{1}{r}\mathbb{Z}$. If however $r$ is half-integer, fusion with $V^d_{\langle 1,2\rangle}$ \eqref{vdvrs} forces us to allow half-integer spins, so that $s\in \frac{1}{r}\mathbb{Z} + \mathbb{Z} = \frac{1}{2r}\mathbb{Z}$. 
...
\begin{itemize}
 ...
 \end{align}
\end{itemize}
Degenerate fields transform trivially under global symmetries... Pseudo-puzzle of $V_{(2, 0)}$ singlet.

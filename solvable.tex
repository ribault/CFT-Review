...
\begin{itemize}
 ...
 \begin{align}
 \boxed{\Big< V_{\Delta_1}(z_1)V_{\Delta_2}(z_2) \Big> \propto \delta_{\Delta_1,\Delta_2} z_{12}^{-2\Delta_1}} \ .
 \label{2pt}
\end{align}
...
\begin{align}
 \boxed{\left< \prod_{i=1}^3 V_{\Delta_i}(z_i) \right> \propto z_{12}^{\Delta_3-\Delta_1-\Delta_2} z_{13}^{\Delta_2-\Delta_1-\Delta_3} z_{23}^{\Delta_1-\Delta_2-\Delta_3}}\ .
 \label{3pt}
\end{align}
...
\begin{align}
 \Big< V_{\Delta_1}(z) V_{\Delta_2}(0)V_{\Delta_3}(\infty)V_{\Delta_4}(1) \Big> = G(z)\ . 
\end{align}
\end{itemize}
...
\begin{align}
 ...
 \label{sdd} 
\end{align}
A \textbf{spinless field} $V_\Delta(z)=V_{\Delta,\Delta}(z)$ is a primary field whose spin vanishes. The contribution of $V_\Delta$ to the OPE $V_{\Delta_1}(z_1)V_{\Delta_2}(z_2)$ of two other spinless fields is manifestly single-valued, since by Eq. \eqref{prope} the $z_1,z_2$-dependent prefactor is $|z_{12}|^{2(\Delta-\Delta_1-\Delta_2)}$. However, having spinless fields is not necessary for single-valuedness, as we will now see by studying conformally symmetric correlation functions.  

Then single-valuedness of correlation functions. Need also permutation symmetry. 

...
* At the beginning of Section 2.4, made the distinction between critical loop models and loop CFTs.
...
* In Section 2.5.3, mentioned the A-D-E classification of minimal models.
...
* Rewritten the introduction of Section 5.

* Revised Section 5.2.1, which now include the formulas for $n$ and $w(P)$.

* Rewritten Section 5.3.3.

* Simplified Section 5.5.1 in light of more recent developments.

* Terminology: replaced 'relative deviation' with 'deviation'.

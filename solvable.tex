...
There exist additional minimal models for $\beta^2=\frac{q}{p}$ with $p=12, 18, 30$.
They have finitely many primary fields, which belong to fully degenerate representations from the Kac table. 
However, we do not know how to derive them from the study of fusion rules. 
In fact, determining the non-chiral fusion rules of E-series minimal models seems to be an open problem. 

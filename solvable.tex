...
\begin{enumerate}
 \item \textbf{We know the structure constants.} All that remains is to test crossing symmetry of 4-point functions, by numerically computing them in various channels. This has been done in Liouville theory \cite{rs15}, generalized minimal models \cite{rs15}, Runkel--Watts-type CFTs \cite{rs15}, and generalized D-series minimal models  with $c\leq 1$ \cite{rib19}. 

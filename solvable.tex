...
In fact, it is not even clear that OPEs exist in loop CFTs. As far as we know, there is no proof that OPEs exist from the statistical loop models. Hints: blocks, decomp. on known spectrum, not just basis of fct...

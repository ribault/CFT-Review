...
This review: only necessary calculations. Derive the recursion for blocks? hard part is coef $R_{r,s}$ but it obeys simple shift equations. 
...
Axioms including single-valuedness, Ward identities. Degenerate fusion. 

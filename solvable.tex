...
We will remain agnostic on the precise definition of $\mathcal{E}$. We will only assume that numbers of loops are finite, $|E|<\infty$. 

product of weights of loops. All loops have same weight. But in fact $W(E)$ also depends on nb of lattice edges in loops. 

...
Only integer spins, no deg. fields.
...
Non-intersecting loops with certain weights. In partition function, all loops have same weight by conformal symmetry. Then introduce fields, diagonal or not. Weight factors as allowed by conformal symmetry. Combinatorial maps. 

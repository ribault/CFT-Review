...
15- No change, for fear of confusing readers with this subtle point. In a minimal model, we have 2 ways of writing the identity field $V^f_{\langle 1,1\rangle}=V^d_{\langle 1,1\rangle}$. In other words, the second null vector of $V^d_{\langle 1,1\rangle}$ vanishes in all of the model's correlation functions. There might exist models where this is not true. XXXX

...
\begin{align}
 ...
 \label{bc}
\end{align}
It is indeed straightforward to check that these expressions obey the shift equations \eqref{sh-mp}-\eqref{sh-b} with $s_i=0$ and $P_i=\bar P_i$. Therefore, the 2-point and 3-point functions can be analytically continued beyond the half-line $c\in (-\infty ,1]$, while $n\geq 4$-point functions cannot, as follows from our discussion of the OPE in Section \ref{sec:liou}. 

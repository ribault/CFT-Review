...
\section{The Virasoro algebra, its representations, Ward identities, fusion rules}

i.e. chiral CFT. 

Including logarithmic representations?

But we also need single-valuedness so we can guess spectrums. 

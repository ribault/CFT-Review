...
shift equations insufficient by far. Weights are invariant

Find one nice solution, remaining equations simple. Plus conjecture: polynoms (modulo subracting poles). 

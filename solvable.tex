...
Focus on left-moving first. 

like OPEs: focus on primaries for technical simplicity, insert $T$ to get Ward identities. 

assume behaviour of $T$ at infinity 

Get descendants from primaries. We already saw it in OPEs.

Global conformal symmetry. Define fields at infinity. 

1, 2, 3, 4 point functions. Then single-valuedness. Need also permutation symmetry. 

...
There are other solved or solvable CFTs that we will not mention, because they have \textbf{extended chiral algebras}, which means extra local symmetries in addition to conformal symmetry. Some CFTs of that type can be solved with the methods that we will explain, for example certain Wess--Zumino--Witten models. 

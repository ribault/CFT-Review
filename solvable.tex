...
\begin{itemize}
 ...
 \item I am grateful to the 2 anonymous SciPost reviewers for their valuable suggestions, which led to many corrections and clarifications.
...
- At the end of Section 1.4, summarized notations and clarified the relation with irreducibility.

- Rewritten Section 1.2.3 after Eq. (1.54), in order to clarify in which cases descendants are determined by primaries. Also modified the last sentence of Section 1.2.4.

- At the beginning of Section 1.2.4, added a clause assuming $\beta^2\notin\mathbb{Q}$. Added the same assumption at the beginning of 1.2.5, as suggested by the referee.

- At the beginning of Section 1.2, sketched how fields are constructed in two other types of approaches.

- Before (1.22), removed the superfluous assumption that $p,q$ are coprime, making it clearer that $(p, q)=(1,1)$ is allowed.

- More explanations before what is now Eq. (2.35), to better describe the limit.

...
\end{align}
This reduces the problem to determining $c^{r,s}$. To do this, let us find how $c^{r,s}$ behaves under $r\to r+2$ and $s\to s+2$, using a chiral version of the analytic bootstrap of Section \ref{sec:ab}. 

To determine these chiral correlators, bootstrap similar to structure constants, using degenerate fields. Degenerate coefficients similarly ignored. 

Solution: write as double Gamma or as big product. 

...
Runkel--Watts-type: can we get it as limit GMM? Or do we need MM?

Summary of limits for CFTs with 2 deg. fields? 

Can we see whether in Liouville theory fields with deg. dimensions are actually deg.? For $c\leq 1$, guess not deg. from MM limit. For other $c$, need to know about poles of struct. csts. So answer is probably no. Postpone the problem to analysis of correl. 

...
\ .
\end{align}
The corresponding CFT may be called a \myindex{fermionic minimal model}\index{minimal model!fermionic---} \cite{rw20}. The fusion rules are obtained by combining the fully degenerate fusion rules \eqref{rfrf} with the conservation of diagonality:
\begin{align}
...
\begin{align}
 \mathcal{N} = \dim\left\{\left(D^{(x)}_k\right)_{k,x}\middle|\text{crossing symmetry is obeyed}\right\}\ . 
 \label{nsol}
\end{align}
...
\renewcommand{\arraystretch}{1.1}
 \begin{array}{|l|r|r|}
  \hline 
  (r, s) & \epsilon_{(r,s)}^{(s)|30}  & \Re D_{(r,s)}^{(s)|30} 
  \\
  \hline 
  (1,0)&    10^{-18} &  \underline{0.835858557220692784}792 \\
(1,1)&    10^{-18} & -\underline{0.944165038467493446}147\\
(2,0)&    10^{-14} & -\underline{0.0011893356520367}3777\\
(2,\frac12)&    0.3 & -1.21147269262699\times 10^{-16}\\
(2,1)&    0.3 & 4.99187095111020\times 10^{-17}\\
(2,-\frac12)&    0.3 & 1.25237256541221\times 10^{-16}\\
(3,0)&    10^{-6} & \underline{9.84485}847601752\times 10^{-10}\\
(3,\frac13)&    0.6 & -5.74736982467510\times 10^{-15}\\
(3,\frac23)&    0.4& 7.01620439899040\times 10^{-15}\\
(3,1)&    0.3 & -5.44191922150011\times 10^{-15}\\
(3,-\frac13)&    0.8 & 1.07388354002910\times 10^{-14}\\
(3,-\frac23)&    0.5 & -1.6038800197982\times 10^{-14}\\
(4,0)&    2 & 5.03706865497229\times 10^{-11}\\
(4,\frac14)&    1.8 & 1.30119782124619\times 10^{-11}
\\
\hline \hline 
 (r, s) & \epsilon_{(r,s)}^{(t)|30}  & \Re D_{(r,s)}^{(t)|30} 
\\
\hline 
(\frac52,0)&    10^{-14}&  -\underline{0.0010412053694212}4585 \\
(\frac52,\frac25)&    10^{-14}&  \underline{0.0017166502423150}3582\\
(\frac52,\frac45)&    10^{-14}&  \underline{0.0059313459276285}2052\\
(\frac52,-\frac25)&    1.8 & -2.97931525390506\times 10^{-16}\\
(\frac52,-\frac45)&    1.7 & 2.37906874707515\times 10^{-16}\\
(\frac72,0)&    10^{-7}&  \underline{0.000003232162}50954141\\
(\frac72,\frac27)&    10^{-7}&  \underline{0.000003169649}86457358\\
(\frac72,\frac47)&    10^{-7}&  \underline{0.000002044085}78740659\\
(\frac72,-\frac27)&    1.2 & 1.32378198677384\times 10^{-13}\\
(\frac72,-\frac47)&    1.3 & -2.5787960841892\times 10^{-13}\\
(\frac72,-\frac67)  &  1.3 & 2.88260109815161\times 10^{-13}\\
(\frac92,0) &   0.5  & 9.99751044956889\times 10^{-9}\\
(\frac92,\frac29) &    0.5 & 5.4083524879818\times 10^{-9}
\\
\hline 
 \end{array}
\end{align}
...
Explicit example of a table of deviations. Point out 2 origins of large deviations. Underline digits that are confirmed by higher precision. Ideally, higher precision determines more structure constants. 

...
Now, let us extend the conformal algebra $\mathfrak{V}\times \bar{\mathfrak{V}}$ by adding a generator $D$ such that 
\begin{align}
...
\begin{align}
 [L_0, D] =  \  , \ [L_{n\neq 0},D] =\ .
\end{align}
is $n=0$ really special?

resulting alg not factorized could have had $\bar D$ but it makes no sense to shift only left/right so we do not want 2 indep generators. 

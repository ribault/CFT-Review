...
\begin{align}
 ...
 \begin{array}{|r||c|c|c|c|c|c|c|c|}
  \hline 
  z & 0 & 0 & 1 & \infty & 2 & -1 & \frac12 & e^{\pm i\frac{\pi}{3}}
  \\
  \hline 
...
\begin{align}
 ...
 \node at (.95, .35) {$q$};
  ...
  \draw[red] (-.93, 0) to [out = 0, in = 150] (0, .066) to [out = -30, in = 90] (.043, 0) to [out = -90, in = 30] (0, -.066) to [out = -150, in = 0] (-.93, 0);
  \draw[red] (.93, 0) to [out = 180, in = 30] (0, .066) to [out = -150, in = 90] (-.043, 0) to [out = -90, in = 150] (0, -.066) to [out = -30, in = 180] (.93, 0);
  \draw[ultra thick, dashed, red] (-.9, 0) -- (.9, 0);
  \draw(0, 0) node[fill, circle, minimum size = 1.4mm, inner sep = 0]{};
  \draw(1, 0) node[fill, circle, minimum size = 1.4mm, inner sep = 0]{};
  \node[below] at (1, 0) {$1$};
  \node at (-.09, -.13) {$0$};
  \draw[-latex] (-.06, -.09) -- (-.015, -.022);

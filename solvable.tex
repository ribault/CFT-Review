...
\begin{align}
 ...
 \label{gl11}
\end{align}
Let us show that these ratios are related to the universal OPE coefficients $f^{\Delta, L}_{\Delta_1,\Delta_2}$ \eqref{prope}. 
In principle straightforward but tricky 
because fields at infinity...
% NB: to be continued

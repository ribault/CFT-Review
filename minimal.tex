...
Now, in the case of Liouville theory, let us determine the coefficients $c^{(s)}_{ij}$ in terms of OPE coefficients and three-point structure constants. Using the degenerate OPE \eqref{degope} and the three-point function \eqref{eq:vvv}, we find
\begin{align}
...
\begin{enumerate}
 \item In Sections 4 and 5, I have made the technical simplification of eliminating the reflection relation and the associated reflection coefficient. Instead, I have introduced a two-point structure constant $B(\alpha)$ in eq. (4.10). 
...
Reply to Reviewer 3:
\begin{enumerate}
 \item Strictly speaking, the OPE of degenerate fields is not covered by Axiom 3.4, because the degenerate fields do not belong to the spectrum. So I have taken this issue as a gap to be filled, rather than a contradiction to be resolved. After Axiom 4.10 on the existence of degenerate fields, I have therefore discussed how Axiom 3.4 should be generalized to the OPE in question. The generalization is dictated by the fusion rules.

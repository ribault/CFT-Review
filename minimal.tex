...
I am grateful to the reviewers and editor for their work. I have made many changes, especially in Sections 4 and 5, mainly in order to add or improve explanations. As a result, the revised version is about 3 pages longer than the submitted version, while keeping the same plan. Let me comment on some of the most important changes, before addressing the reviewers' specific concerns:
\begin{enumerate}
 ...
 \item I have added 8 references, including some general references that are cited in the Introduction. These general references can serve as guides to the original literature, a role that the present notes do not strive to fulfill. Most references are textbooks or review articles. They do not detract from the self-contained nature of these notes, with the exception of ref. [1] as is now made clear in the Introduction.
\end{enumerate}
Reply to Reviewer 1:
\begin{enumerate}
...
\end{enumerate}
Reply to Reviewer 2: I have done a major revision and expansion of Sections 4 and 5 in the hope of clarifying them, while also improving the rest of the text in a more perturbative fashion. Let me now address the 'minimal set of comments': 
\begin{enumerate}

...
\begin{itemize}
 \item The free boson (Appendix \ref{sec:fb}) is not needed in our approach, because we do not build CFTs as perturbed free theories, as is done in the Lagrangian approach. However, it is a good preparation to the study of of CFTs based on larger symmetry algebras, in particular WZW models. 

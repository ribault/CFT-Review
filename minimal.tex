...
Reply to Reviewer 3:
\begin{enumerate}
 \item There was indeed a contradition because Axiom 3.4 was formulated too strongly. I have modified that Axiom so that it applies only to fields that correspond to states in the spectrum. Then OPEs of degenerate fields are not covered, and should be discussed separately. I have added such a discussion after Axiom 4.10. 
